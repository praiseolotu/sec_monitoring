...
class productTransaction(models.Model):
    ...
    deposit                 = models.DecimalField(max_digits=12,decimal_places=2,null=False,blank=False)
    deposit_amount          = models.DecimalField(max_digits=12,decimal_places=2,editable=False, default=0,null=True)
