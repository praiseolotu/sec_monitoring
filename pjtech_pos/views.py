...
class EnterBarcode(forms.Form):
    ...
    qty = forms.FloatField(label="Quantity",widget=forms.TextInput(attrs={'style':"width:100%"}))
        ...
        try:
            ...
            response = response + f"""</table> </div> 
                                        <div class="card-footer py-3">
                                            <h3 class="m-0 font-weight-bold text-primary">Transaction Total:
                                            <span class="m-0 font-weight-bold text-dark" style="float:right;item-align:right">₦ {total:.2f}</span>
                                            </h3>
                                            <h3 class="m-0 font-weight-bold text-primary">Account Number:
                                            <span class="m-0 font-weight-bold text-dark" style="float:right;item-align:right">3171230234</span>
                                            </h3>
                                            <h3 class="m-0 font-weight-bold text-primary">Bank:
                                            <span class="m-0 font-weight-bold text-dark" style="float:right;item-align:right">Moniepoint</span>
                                            </h3>
                                        </div>
                                    </div>"""
